    ...
    return (
        <div className="flex mt-10 items-center justify-center">
            ...
            <div className="border">
                ...
                <Image className="border-r" src='/devider.png' width={50} height={80} alt="devider" />
            </div>
            </div>
            <div className="flex w-full items-center relative text-center justify-center flex-col">
                <Image className="" src={'/banner.png'} width={457} height={400} alt="banner" />
                <div className="absolute top-40 space-y-6">
